...
$sql = "SELECT id, firstName, lastName,  points FROM employee, rank WHERE rank.eid = employee.id order by employee.id";
...
<html>
<head>
	<title>Admin Panel | EMS Project</title>
...
<body>
	...
	<div id="divimg">
		<h2 style="font-family: 'Montserrat', sans-serif; font-size: 25px; text-align: center;">Empolyee List </h2>
    	<table>
